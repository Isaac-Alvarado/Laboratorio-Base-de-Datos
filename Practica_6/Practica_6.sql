/*NUEVO SCRIPT DE LA BASE DE DATOS*/

CREATE DATABASE [Ferreteria2.2]

USE [Ferreteria2.2]
GO
/****** Object:  Table [dbo].[CLIENTES]    Script Date: 25/10/2017 23:30:11 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[DETALLE_VENTA]    Script Date: 25/10/2017 23:30:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[EMPLEADO]    Script Date: 25/10/2017 23:30:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[ENTRADAS]    Script Date: 25/10/2017 23:30:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FACTURAS]    Script Date: 25/10/2017 23:30:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PAGO]    Script Date: 25/10/2017 23:30:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[PRODUCTOS]    Script Date: 25/10/2017 23:30:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[PROVEEDOR]    Script Date: 25/10/2017 23:30:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[SALIDAS]    Script Date: 25/10/2017 23:30:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[VENTAS]    Script Date: 25/10/2017 23:30:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SELECT * FROM Reporte_3




CREATE VIEW Reporte_4 as
...
where prov.id_provedor = 1
GROUP BY prov.nombre, p.id_producto, p.nombre

SELECT * FROM Reporte_4




CREATE VIEW Reporte_5 as
...
SELECT * FROM Reporte_5


/*Subconsulta de parentesis*/

SELECT MNT.* FROM
(SELECT id_folio ,Nombre_Empleado , Fecha_Hora, monto
FROM Reporte_1 
GROUP BY id_folio, Fecha_Hora, Nombre_Empleado,monto ) as MNT
WHERE monto > 300 
